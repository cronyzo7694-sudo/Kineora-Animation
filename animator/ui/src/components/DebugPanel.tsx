...
export function DebugPanel({
  ...
  return (
    <aside data-testid="debug-panel" aria-label="Developer panel" style={{ width: '100%', boxSizing: 'border-box', height: '100%', borderLeft: '1px solid #333', background: '#161616', padding: 10, overflow: 'auto', fontSize: 12, color: '#aaa' }}>
